...
document
  .querySelectorAll(".carousel__nav li")
  .forEach(function (indicator, ind) {
    indicator.addEventListener("click", function () {
      sectionIndex = ind;
      console.log(ind);
      console.log(calDots);
      let translateVal = sectionIndex * cardWidth * itemToScroll;
      if (ind == calDots && cardLength % 2 != 0 && itemToScroll != 1) {
        translateVal = translateVal - cardWidth;
      }
      document
        .querySelector(".carousel__nav .selected")
